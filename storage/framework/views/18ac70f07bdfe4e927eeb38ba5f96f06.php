...
<div class="container">
    ...
    <div class="table-container">
        <table class="order-table" id="orderTable">
            <thead>
                <tr>
                   <!-- Show Priority column on mobile -->
                   <th >Priority</th>
                    <!-- Gig ID always visible -->
                    <th class="d-md-table-cell">Gig ID</th>
                    <!-- Show Buyer ID on desktop, hide on mobile -->
                    <th class="d-none d-md-table-cell">Buyer ID</th>
            ...
            <tbody>
                <?php if(count($orders) > 0): ?>
                 <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td><?php echo e($order->is_urgent == 0 ? 'No' : 'Yes'); ?></td>
                        <td class="d-md-table-cell"><?php echo e($order->gig_id); ?></td>
                        <td class="d-none d-md-table-cell"><?php echo e($order->buyer_id); ?></td>

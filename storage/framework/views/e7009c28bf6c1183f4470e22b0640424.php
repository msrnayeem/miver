...
<div class="container px-0">
    ...
    <div class="row my-5 py-5"> <!-- Added mb-4 class to add bottom margin -->
        ...
        <div class="col-md-8">
            ...
            <div class="imageContainer" title="Profile Picture" >
                ...
                <div class="middle" >
                    <i class="fa fa-camera" style="font-size:36px; color:black;"></i>
                </div>
            </div>
    ...
    <div class="row my-2 py-2 text-end">
        <a href="<?php echo e(route('seller.professional.info')); ?>"><span class="btn btn" style="background-color:#1dbf73; color:white; padding-inline:40px">Continue</span></a>
    </div>
</div>

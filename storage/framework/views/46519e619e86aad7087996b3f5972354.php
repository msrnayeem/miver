...
<div class="CategoryContainer">
    ...
    <div class="categories">
        ...
        <div class="card">
        <img src="" alt="<?php echo e($category->name); ?>">
            ...
            <ul>
                ...
                <li><a href="<?php echo e(route('allProduct')); ?>"><?php echo e($subSubCategory->name); ?></a></li>
...
<div class="GuideContainer">
    ...
    <div class="categories">
        <?php if(!$category->guides->isEmpty()): ?>
            ...
            <div class="card">
                <img src="<?php echo e($guide->imageLink); ?>" alt="Logo & Brand Identity">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Shahidur project\project\miver\resources\views/pages/category/categoryMaster.blade.php ENDPATH**/ ?>
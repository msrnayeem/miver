        ...
        <div class="col-md-5 left-content" style=" margin-right:20px; margin-left:-20px;">
            <div class="profile-card">
                    <div class="profile-image-wrapper">
                         ...
                         <img src="<?php echo e(asset('uploads/'.$user->id.'.jpg')); ?>" alt="Profile Image" class="profile-image">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 text-md-end">
                        <p class="profile-info"><?php echo e(\Carbon\Carbon::parse($user->created_at)->format('M d, Y')); ?></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-7 right-content">
            <div class="row mx-0" >
                ...
                <div class="categories" id="for_gigs">
                    <div class="card">
                        <img src="<?php echo e(asset('image.png')); ?>" alt="name">

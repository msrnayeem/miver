...
<div class="CategoryBanner">
    <img src="<?php echo e(asset('assets/images/category/digital-marketing-desktop.png')); ?>" alt="digital marketing">
...
<div class="CategoryContainer">
    ...
    <div class="categories">
        <div class="card">
            <img src="<?php echo e(asset('assets/images/category/search.png')); ?>" alt="search">
            <h3>Search</h3>
            <ul>
        ...
        <div class="card">
            <img src="<?php echo e(asset('assets/images/category/social.png')); ?>" alt="social">
            <h3>Social</h3>
            <ul>
                <li><a href="#">List item 1</a></li>
                <li><a href="#">List item 2</a></li>
        ...
        <div class="card">
            <img src="<?php echo e(asset('assets/images/category/advertising.png')); ?>" alt="advertising">
            <h3>Advertising</h3>
            <ul>
                <li><a href="#">List item 1</a></li>
                <li><a href="#">List item 2</a></li>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\miver\resources\views/pages/category/digitalMarketing.blade.php ENDPATH**/ ?>
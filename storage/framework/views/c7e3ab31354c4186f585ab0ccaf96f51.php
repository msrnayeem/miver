                    ...
                    <ul>
                      ...
                      <li id="profile">
                        ...
                        <div class="profile-container" id="userDropdown"> 
                          ...
                          <?php if($is_admin): ?>
                            <div class="notification-item even"><a href="<?php echo e(route('admin.panel')); ?>" class="profile-item odd">Admin Panel</a></div>
                          <?php else: ?>
                            <div class="notification-item odd"><a href="<?php echo e(route('user.gig.orders')); ?>" class="profile-item even">Orders</a></div>
                            <div class="notification-item odd"><a href="<?php echo e(route('user.gig.myorders')); ?>" class="profile-item even">Placed Orders</a></div>
                          <?php endif; ?>

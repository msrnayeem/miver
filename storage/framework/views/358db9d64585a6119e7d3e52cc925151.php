  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a class="btn btn-danger btn-sm" type="button" href="<?php echo e(route('logout')); ?>"">Logout</a>
      </div>
    </div>
  </div>
</div> 
...
<ul class="navbar-nav ml-auto">      
  ...
  <li class="nav-item dropdown">
    ...
    <img
            src="<?php echo e(asset('uploads/1.jpg')); ?>"
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="<?php echo e(asset('uploads/1.jpg')); ?>" class="rounded-circle"
            height="35"
            alt="profile icon"
           >
        </div>
...
<?php /**PATH C:\xampp\htdocs\miver\resources\views/inc/left-top.blade.php ENDPATH**/ ?>